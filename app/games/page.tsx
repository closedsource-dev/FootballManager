              ...
              <>
                ...
                {!submitted ? (
                  <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 shadow-sm p-5">
                    ...
                    <button onClick={handleSubmitScore} disabled={submitting || scoreA === "" || scoreB === ""}
                      className="w-full mt-4 bg-green-700 text-white py-2 rounded-lg text-sm font-medium hover:bg-green-800 transition-colors disabled:opacity-40">
